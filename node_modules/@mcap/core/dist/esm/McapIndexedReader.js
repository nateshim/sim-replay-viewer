...
import { CachedReadable } from "./CachedReadable.js";
import { ChunkCursor } from "./ChunkCursor.js";
import Reader from "./Reader.js";
import { MCAP_MAGIC } from "./constants.js";
...
export class McapIndexedReader {
    ...
    static async Initialize({ readable, decompressHandlers, messageIndexCacheSizeBytes, }) {
        ...
        let headerEndOffset;
        {
            ...
            const headerContentLength = headerPrefixView.getBigUint64(MCAP_MAGIC.length + /* Opcode.HEADER */ 1, true);
