...
import McapStreamReader from "./McapStreamReader.js";
import { McapWriter } from "./McapWriter.js";
import Reader from "./Reader.js";
import { TempBuffer } from "./TempBuffer.js";
import { MCAP_MAGIC, Opcode } from "./constants.js";
import { parseMagic, parseRecord } from "./parse.js";
import { collect, keyValues, record, string, uint16LE, uint32LE, uint64LE } from "./testUtils.js";
function readAsMcapStream(data) {
...
describe("McapWriter", () => {
    ...
    it("supports chunk compression", async () => {
        ...
        expect(records).toEqual([
            ...
            {
                type: "ChunkIndex",
                chunkLength: expect.any(BigInt),
                chunkStartOffset: 25n,
                compressedSize: BigInt(2 * expectedChunkData.byteLength),
                compression: "reverse double",
                messageEndTime: 0n,
                messageIndexLength: 31n,
                messageIndexOffsets: new Map([[0, expect.any(BigInt)]]),
                messageStartTime: 0n,
                uncompressedSize: BigInt(expectedChunkData.byteLength),
            },
            {
                type: "Footer",
                summaryCrc: expect.any(Number),
                summaryOffsetStart: expect.any(BigInt),
                summaryStart: expect.any(BigInt),
            },
        ]);
    });
    it("supports append mode", async () => {
        ...
        expect(originalRecords).toEqual([
            ...commonRecords,
            {
                type: "DataEnd",
        ...
        const expectedDataCrc = crc32(tempBuffer.get().slice(0, Number(newSummaryStart - dataEndLength)));
    ...
    it.each([true, false])("respects data_section_crc present=%s when appending", async (useDataSectionCrc) => {
        ...
        const tempBuffer = new TempBuffer(new Uint8Array([
            ...originalDataSection,
        ...
        expect(tempBuffer.get()).toEqual(new Uint8Array([
            ...newDataSection,
            ...record(Opcode.DATA_END, [
...
//# sourceMappingURL=McapWriter.test.js.map