...
class McapStreamReader {
    #buffer = new ArrayBuffer(constants_ts_1.MCAP_MAGIC.length * 2);
    #view = new DataView(this.#buffer, 0, 0);
    #reader = new Reader_ts_1.default(this.#view);
    #decompressHandlers;
    #includeChunks;
    #validateCrcs;
    #noMagicPrefix;
    ...
    #appendOrShift(data) {
        ...
        if (neededCapacity <= this.#buffer.byteLength) {
            ...
            if (this.#view.byteOffset + this.#view.byteLength + data.byteLength <=
    ...
    *#read() {
        if (!this.#noMagicPrefix) {
            let magic;
            while (((magic = (0, parse_ts_1.parseMagic)(this.#reader)), !magic)) {
                yield;
            }
        }
        let header;
        ...
        for (;;) {
            let record;
            while (((record = (0, parse_ts_1.parseRecord)(this.#reader, this.#validateCrcs)), !record)) {
                yield;
            }
            switch (record.type) {
                case "Header":
                ...
                case "Chunk": {
                    ...
                    const chunkReader = new Reader_ts_1.default(view);
                    let chunkRecord;
                    while ((chunkRecord = (0, parse_ts_1.parseRecord)(chunkReader, this.#validateCrcs))) {
...
exports.default = McapStreamReader;
...
//# sourceMappingURL=McapStreamReader.js.map