...
const ChunkBuilder_ts_1 = require("./ChunkBuilder.js");
describe("ChunkBuilder", () => {
    it("generates correct messageStartTime/messageEndTime for messages with logTime 0", () => {
        const builder = new ChunkBuilder_ts_1.ChunkBuilder({ useMessageIndex: true });
        builder.addMessage({
            channelId: 0,
            data: new Uint8Array(),
            sequence: 0,
...
//# sourceMappingURL=ChunkBuilder.test.js.map