...
const McapRecordBuilder_ts_1 = require("./McapRecordBuilder.js");
describe("McapRecordBuilder", () => {
    it("writes magic", () => {
        const writer = new McapRecordBuilder_ts_1.McapRecordBuilder();
        writer.writeMagic();
    ...
    it("writes header", () => {
        ...
        const buffer = new BufferBuilder_ts_1.BufferBuilder();
        buffer
            .uint8(1) // opcode
...
//# sourceMappingURL=McapRecordBuilder.test.js.map