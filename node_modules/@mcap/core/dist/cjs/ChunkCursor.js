...
exports.ChunkCursor = void 0;
const Reader_ts_1 = require("./Reader.js");
const parse_ts_1 = require("./parse.js");
const sortedIndexBy_ts_1 = require("./sortedIndexBy.js");
const sortedLastIndex_ts_1 = require("./sortedLastIndex.js");
/**
...
class ChunkCursor {
    ...
    async loadMessageIndexes(readable) {
        ...
        const reader = new Reader_ts_1.default(messageIndexesView);
        const arrayOfMessageOffsets = [];
        let record;
        while ((record = (0, parse_ts_1.parseRecord)(reader, true))) {
        ...
        if (startTime != undefined) {
            startIndex = (0, sortedIndexBy_ts_1.sortedIndexBy)(this.#orderedMessageOffsets, startTime, iteratee);
        }
        if (endTime != undefined) {
            endIndex = (0, sortedLastIndex_ts_1.sortedLastIndexBy)(this.#orderedMessageOffsets, endTime, iteratee);
        }
...
exports.ChunkCursor = ChunkCursor;
//# sourceMappingURL=ChunkCursor.js.map