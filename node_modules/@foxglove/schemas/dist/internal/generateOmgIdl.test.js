...
describe("generateOmgIdl", () => {
    ...
    const allIdlFiles = new Map([
        ...Object.values(schemas_1.foxgloveMessageSchemas).map((schema) => [
            (0, generateOmgIdl_1.omgIdlMessageSchemaName)(schema),
            (0, generateOmgIdl_1.generateOmgIdl)(schema),
        ]),
        ...Object.values(schemas_1.foxgloveEnumSchemas).map((schema) => [
            schema.name,
            (0, generateOmgIdl_1.generateOmgIdl)(schema),
        ]),
    ]);
