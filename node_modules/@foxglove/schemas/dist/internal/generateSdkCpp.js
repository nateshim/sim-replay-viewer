 ...
 * in other languages.
 */
function shouldGenerateChannel(schema) {
...
function generateHppSchemas(schemas, enums) {
    ...
    const channelClasses = schemas.filter(shouldGenerateChannel).map((schema) => `/// @brief A channel for logging ${schema.name} messages to a topic.
      ///
