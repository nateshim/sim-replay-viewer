...
describe("generateFlatbuffers", () => {
    ...
    it("throws on duplicate flatbuffersFieldNumber", () => {
        ...
        expect(() => (0, generateFlatbufferSchema_1.generateFlatbuffers)(schema, [])).toThrow("More than one field with flatbuffersFieldNumber 0");
    });
    it("emits null defaults for optional primitive scalars only", () => {
        const optionalPrimitiveTypes = [
            "int32",
            "uint32",
            "boolean",
            "float64",
        ...
        expect((0, generateFlatbufferSchema_1.generateFlatbuffers)(schema, [])).toMatchInlineSnapshot(`
      "// Generated by https://github.com/foxglove/foxglove-sdk
    ...
    it("emits null defaults for optional enum fields only", () => {
            ...
            fields: [
                {
                    ...
                    type: { type: "enum", enum: testFixtures_1.exampleEnum },
                    optional: true,
                },
                {
        ...
        expect((0, generateFlatbufferSchema_1.generateFlatbuffers)(schema, [testFixtures_1.exampleEnum])).toMatchInlineSnapshot(`
      "// Generated by https://github.com/foxglove/foxglove-sdk
    ...
    it("throws when an optional FlatBuffer scalar field also has a default value", () => {
        ...
        expect(() => (0, generateFlatbufferSchema_1.generateFlatbuffers)(boolSchema, [testFixtures_1.exampleEnum])).toThrow('Field "optional_bool_with_default": optional FlatBuffer scalar fields cannot have a default value');
        expect(() => (0, generateFlatbufferSchema_1.generateFlatbuffers)(enumSchema, [testFixtures_1.exampleEnum])).toThrow('Field "optional_enum_with_default": optional FlatBuffer scalar fields cannot have a default value');
    });
});
