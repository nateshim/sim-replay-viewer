...
exports.generateSchemaPrelude = generateSchemaPrelude;
exports.generatePyclass = generatePyclass;
exports.generatePySchemaStub = generatePySchemaStub;
exports.generatePyMessageModule = generatePyMessageModule;
exports.generatePySchemaModule = generatePySchemaModule;
exports.generateSchemaModuleRegistration = generateSchemaModuleRegistration;
exports.generateChannelClasses = generateChannelClasses;
exports.generatePyChannelStub = generatePyChannelStub;
exports.generatePyChannelModule = generatePyChannelModule;
/**
 * Generate the module header for schema pyclass definitions.
 */
function generateSchemaPrelude() {
    const docs = [
 ...
 */
function generatePyclass(schema) {
 ...
 */
function generatePySchemaStub(schemas, { unionName = "FoxgloveSchema" } = {}) {
    const header = [
        "# Generated by https://github.com/foxglove/foxglove-sdk",
 ...
 */
function generatePyMessageModule(schemas) {
 ...
 */
function generatePySchemaModule(schemas) {
    const allSchemas = schemas
        .filter(isMessageSchema)
        .map((schema) => pyClassName(schema))
        .sort();
 ...
 */
function convertMarkdownLinksToRst(text) {
...
function generateMessageClass(schema) {
    ...
    function fieldAssignment(field) {
...
function generateEnumClass(schema) {
    const name = enumName(schema);
 ...
 */
function pythonDefaultValue(field) {
 ...
 */
function rustDefaultValue(field) {
    if (field.type.type === "primitive" && field.type.name === "bytes") {
        // Special case — this is an `Option<Bound<'_, PyBytes>>`; see `rustOutputType`
        return "None";
    }
 ...
 */
function pythonType(foxglovePrimitive) {
...
function constantToTitleCase(str) {
    return str
        .split("_")
...
function constantToKebabCase(name) {
    return name
 ...
 */
function generateSchemaModuleRegistration(schemas) {
 ...
 */
function shouldGenerateSchemaClass(schema) {
 ...
 */
function shouldGenerateChannelClass(schema) {
    return schema.name !== "Timestamp" && schema.name !== "Duration";
}
/**
 ...
 * https://pyo3.rs/v0.23.4/module.html
 */
function generateChannelModuleRegistration(schemas) {
    return `
pub fn register_submodule(parent_module: &Bound<'_, PyModule>) -> PyResult<()> {
 ...
 */
function generateChannelClasses(messageSchemas) {
 ...
 */
function generatePyChannelStub(messageSchemas) {
 ...
 */
function generatePyChannelModule(schemas) {
    const headers = [
        `"""`,
...
//# sourceMappingURL=generatePyclass.js.map